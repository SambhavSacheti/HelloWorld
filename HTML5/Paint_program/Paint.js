...
// Keep track of the previous clicked <img> element for thickness.
var previousLineDashElement;
function changelineDash(dashLength, imgElement) {
  // Change the current drawing thickness.
  ...
  // Return the previously clicked <img> element to its normal state.
  if (previousLineDashElement != null) previousLineDashElement.className = "";
  previousLineDashElement = imgElement;
}
